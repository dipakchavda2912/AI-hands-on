...
class NodeJsPackagesInstructions:
    ...
    def __init__(self, *, clone_path: Optional[str] = None, packages: Optional[List[dict[str, bool | str]]] = None, is_dev: bool = False):
    ...
    def add_single_package(self, package_name: str, is_dev: bool = False) -> str:
    ...
    def add_packages(self) -> List[str]:
        ...
        for pkg in self.packages:
            ...
            if package_name:  # Only add if package name is not empty
                instructions.append(
                    self.add_single_package(package_name, is_dev))
